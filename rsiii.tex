...
\only<3>{may be also charged particles,}%
...
\only<2>{\put(35,130){\includegraphics[scale=0.15]{highlight_circle}}}  \only<2>{\put(35,130){\includegraphics[scale=0.15]{highlight_circle}}}  
\end{picture}
\centering
