...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
    \item \alert{Radiative type-III see-saw}: \tiny{1605.01129, 	
 F. von der Pahlen, G. Palacio, DR, O. Zapata}
    ...
    \item Higgsino-like scotogenic models
      ...
      \item \alert{Radiative type-III see-saw}: {\tiny 1511.06375, S. Fraser, C. Kownacki, E. Ma, O. Popov}\\
...
\only<2>{\put(35,130){\includegraphics[scale=0.15]{highlight_circle}}}  \only<2>{\put(-30,2){\includegraphics[scale=0.15]{highlight_circle}}}  
\only<2>{\put(108,2){\includegraphics[scale=0.15]{highlight_circle}}}  
\end{picture}
\centering
...
For a similar improvement in the wino-like sctogenic model, we could expect exclusions at the level of 900~GeV.
...
plus missing transverse energy} searches, allow for larger sensitivity and 
